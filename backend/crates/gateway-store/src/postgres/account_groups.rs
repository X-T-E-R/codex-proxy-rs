    ...
    async fn load_account_group_members(
        ...
        let rows = sqlx::query(
            "select membership.account_group_id,
                    ...
                    account.weight,
                    account.overload_cooldown_mode, account.overload_cooldown_threshold,
                    account.overload_cooldown_seconds,
                    account.credential_state, account.quota_access_state,
