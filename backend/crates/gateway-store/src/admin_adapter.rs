    ...
    async fn replace_runtime_settings(
        ...
        let replacement = postgres::ControlPlaneReplacement {
            settings: postgres::RuntimeSettingsUpdate {
                ...
                capacity_queue_retry_seconds: command.capacity_queue_retry_seconds,
                capacity_queue_timeout_seconds: command.capacity_queue_timeout_seconds,
...
pub(crate) fn admin_runtime_settings(
    ...
    Ok(AdminRuntimeSettings {
        ...
        capacity_queue_retry_seconds: settings.capacity_queue_retry_seconds,
        capacity_queue_timeout_seconds: settings.capacity_queue_timeout_seconds,
        rotation_strategy,
