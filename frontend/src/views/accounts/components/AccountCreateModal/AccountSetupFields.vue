...
<template>
  <div class="grid gap-6">
    ...
    <AccountSettingsFields
      ...
      v-model:overload-cooldown-mode="form.overloadCooldownMode"
      v-model:overload-cooldown-threshold="form.overloadCooldownThreshold"
      v-model:overload-cooldown-seconds="form.overloadCooldownSeconds"
      :groups="groups"
